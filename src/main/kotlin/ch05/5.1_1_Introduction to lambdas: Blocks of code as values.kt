...
/* Code’unda behavior parçalarını geçirmek ve saklamak sık yapılan bir iştir. Örneğin, sıklıkla şu tür ifadeleri
belirtmen gerekir: “Bir event gerçekleştiğinde, bu handler’ı çalıştır” veya “Bu operation’ı bir data structure içindeki
tüm element’lere uygula.” Java’nın eski sürümlerinde bunu anonymous inner class’lar aracılığıyla yapabilirdin.
Anonymous inner class’lar işi görse de, verbose bir syntax gerektirir. Bu problemi çözmenin bir başka yaklaşımı:
functions'ları values olarak ele alma yeteneğidir. Bir class declare etmek ve o class'ın bir instance'ını bir function'a
geçirmek yerine, function'ı doğrudan geçirebilirsiniz. Lambda expressions ile kod daha da kısa olur. Bir function
declare etmenize gerek yok; bunun yerine, etkili bir şekilde bir kod bloğunu doğrudan function parameter olarak
...
/* Functional programming hakkında hızlı bir hatırlatma, Kotlin’in çok paradigmli bir language olarak doğasını ve
...
parameter olarak geçirebilir veya diğer functions’lardan return edebilirsiniz. Lambdas, bu bölümde keşfedeceğiniz gibi,
Kotlin’in functions’ları first-class citizens olarak rahatça ele almayı sağlayan language özelliklerinden biridir.
...
/* Lambda expressions kullanımının gerçekten öne çıktığı bir örneğe bakalım. Bir butona tıklama behavior’ını
tanımlamanız gerektiğini düşünün. Bunu yapmak için, bir Button object, tıklamayı handle etmek üzere ilgili
OnClickListener interface’inin bir instance’ını geçirmenizi isteyebilir. Bu interface tek bir method, onClick, belirtir.
Kotlin’de bunu, bir object declaration kullanarak implement edebilirsiniz. */
