...
Bir extension function define ettiğinde, otomatik olarak tüm project genelinde kullanılabilir hâle gelmez. Bunun yerine,
diğer class veya function’larda olduğu gibi import edilmesi gerekir. Bu, kazara oluşabilecek name conflict’lerini
önlemeye yardımcı olur. Kotlin, class’lar için kullandığın syntax’ın aynısını kullanarak tek tek function’ları import
etmene izin verir:
