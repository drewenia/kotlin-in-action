...
Bu method, arbitrary (keyfi) sayıda value’yu bir array içinde paketleyerek bir method’a geçirmeni sağlayan bir language
...
Bu örnek, spread operator’ün bir array’den gelen value’ları ve bazı sabit value’ları tek bir call içinde birleştirmeni
