...
Bir variable’a ne zaman yeni bir value atanabileceğini kontrol edebilmek için Kotlin size iki keyword sunar: val ve var.
...
fun main() {
    val result: String
    val result2: String = if (canPerformOperation()) "Success" else "Can't perform operation"
