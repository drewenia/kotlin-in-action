...
Diğer taraftaysan — yani error’ları throw etmek yerine onlardan kurtulmaya çalışıyorsan — exception’ları handle etmek
için catch ve finally clause’larıyla birlikte try construct’ünü kullanırsın. Bunu, bir BufferedReader’dan bir satır
metin okuyan, onu bir sayı olarak parse etmeyi deneyen ve satır geçerli bir sayı değilse sayı ya da null döndüren
...
boilerplate’tir. Kotlin’de compiler, exception’ları handle etmeye seni zorlamaz.
...
Java’nın try-with-resources’ına ne olacak? Kotlin bunun için özel bir syntax’a sahip değildir; bu, bir library function
olarak implement edilmiştir. Chapter 10’da bunun nasıl mümkün olduğunu göreceksin.