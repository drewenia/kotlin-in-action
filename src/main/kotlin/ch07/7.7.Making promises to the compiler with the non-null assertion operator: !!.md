...
Kotlin’de her type’ın bir nullable formu ve bir de non-nullable formu vardır. Örneğin, Int type non-null 32-bit
integer’ları tutabilir. Aynı value’lara ek olarak, Int? type null value’ları da tutabilir. Kotlin, nullable data
type’larla güvenli bir şekilde çalışmayı kolaylaştırmak için birçok seçenek sunar. Ancak bazen, nullable bir type’ı
zorla non-nullable formuna dönüştürmemiz gerekir. Görüldüğü gibi, Kotlin’in not-null assertion operator’ü !! tam olarak
bunu yapar:
