...
Bu, bir subsystem’in implementation detaylarını gizlemenin bir başka yararlı yoludur. img_1.png, tüm visibility
modifier’larını özetler. Bir örneğe bakalım. giveSpeech function’ındaki her satır visibility kurallarını ihlal etmeye
çalışır. Bu durum error ile compile edilir. */

internal open class TalkativeButton413 {
...
fun TalkativeButton413.giveSpeech() {
...
bir member’a erişebilirsiniz. Ancak, bir class’ın internal member’larının adlarının mangled edildiğine dikkat edin.
